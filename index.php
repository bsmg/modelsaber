...
<section class="section">
  <div class="container">
    ...
    <div class="content">
      ...
      <p>If you have the <a href="<?= MODINSTALLER['link'] ?>"><?= MODINSTALLER['name'] ?></a> installed, you can simply click on the <kbd>Install</kbd> buttons to automatically install these models.</p>
