...
<head>
  ...
  <meta name="msapplication-TileImage" content="/favicon/trail/ms-icon-144x144.png">
  <?php if (isset($_GET['id'])):
    require ROOT . '/embed.php';
    getEmbed (TRAIL, $_GET['id']);
  else: ?>
    <!-- Start OEmbed --> 
    <meta content="<?= SITECAMEL ?>" property="og:site_name">
    <meta content="<?= ucfirst(TRAILS) ?>" property="og:title">
    <meta content="Give your waifu whackers some trails" property="og:description">
    <meta content="#ebf4f9" name="theme-color">
    <meta content="/resources/trail.png" property="og:image">
    <!-- End OEmbed -->
  <?php endif; ?>
</head>
<body>
