...
if (isset($_GET['id'])) {
    require '../embed.php';
    getEmbed ("avatar", $_GET['id']);
  } else {
echo <<<EOF
  <!-- Start OEmbed --> 
  <meta content="ModelSaber" property="og:site_name">
  <meta content="Avatars" property="og:title">
  <meta content="Gets your waifus here" property="og:description">
  <meta content="#ebf4f9" name="theme-color">
  <meta content="/resources/avatar.png" property="og:image">
  <!-- End OEmbed -->
EOF;
  }
?>
...
printCards("avatar", $id, $sort, $sort_dir, $limit, '', '*');
?>
    <!-- End Items -->
  </div>
</section>
